...
INSERT INTO MaterialsCode(mat_code_number,mat_code_name,mat_code_spec,mat_code_models,mat_code_num,mat_code_unit,mat_code_sort,mat_code_notes)
                       VALUES
                       ('129734758','混频器','无','ZFM-2-S+','4','个','原材料','无'),
                       ('148634723','隔离器','无','IO-5-850-VLP','5','个','原材料','无'),
                       ('109237568','平凹透镜','852 D12.7 f=25.4','无','6','片','原材料','无'),
                       ('132807456','平凸透镜','852 D12.7 f=38.1','无','3','片','原材料','无'),
                       ('123097534','光卡','无','VRC2','4','个','耗材','无'),
                       ('121397543','扩束镜1','无','GBE05-B','8','个','原材料','无'),
                       ('121397544','扩束镜2','无','BE052-B','4','个','原材料','无'),
                       ('123098234','EOM','无','PM7-NIR-L61301','2','个','原材料','无');
